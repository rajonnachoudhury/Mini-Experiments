...
select "Weekly_Sales","Date","Fuel_Price","Unemployment" from walmart_sales ws order by "Weekly_Sales" desc limit 1;

-- lowest weekly_sale on 3rd December 2010
select "Weekly_Sales","Date","Fuel_Price","Unemployment" from walmart_sales ws order by "Weekly_Sales" asc limit 1;
